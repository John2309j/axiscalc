      ...
      <section className="columns">
        ...
        <div className="column" role="region" aria-labelledby="personal-loan">
          ...
          <div className="final_info">
            ...
            <div>
              <button className="applybtn" aria-label="Apply for Personal Loan" onClick={ApplyFn}>Apply Now</button>
            </div>
          </div>
        </div>
        ...
        <div className="column" role="region" aria-labelledby="home-loan">
          ...
          <div className="final_info">
            ...
            <div>
              <button className="applybtn"  aria-label="Apply for Home Loan" onClick={ApplyFn}>Apply Now</button>
            </div>
          </div>
        </div>
        ...
        <div className="column" role="region" aria-labelledby="car-loan">
          ...
          <div className="final_info">
            ...
            <div>
              <button className="applybtn"  aria-label="Apply for Car Loan" onClick={ApplyFn}>Apply Now</button>
            </div>
          </div>
        </div>
      </section>
